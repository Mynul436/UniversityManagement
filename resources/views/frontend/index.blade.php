...
<section class="bg-gray-100 mb-20">
    <div class="">
        {{-- <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0"> --}}
            ...
            {{-- <img class="object-cover object-center rounded" alt="hero" src="http://127.0.0.1:8000/img/banner.jpg"> --}}
                 {{-- <img class="" alt="hero" src="http://127.0.0.1:8000/img/banner.jpg"> --}}

                 <div style="background-image: url('http://127.0.0.1:8000/img/banner.jpg'); background-size: cover; background-position: center; height: 100vh;"></div>
