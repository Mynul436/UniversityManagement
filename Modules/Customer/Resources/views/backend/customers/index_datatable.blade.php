...
<script type="module">
    $('#datatable').DataTable({
        ...
        //     },
            ...
            {
                data: 'referrer_pos_id',
                name: 'referrer_pos_id'
            },
            {
                data: 'referee_mobile_number',
                name: 'referee_mobile_number'
            },
            {
                data: 'referee_name',
                name: 'referee_name'
            ...
            {
                data: 'relationship_with_referrer',
                name: 'relationship_with_referrer'
            },
