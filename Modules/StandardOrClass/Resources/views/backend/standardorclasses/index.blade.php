                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("standardorclass::text.name")
                            </th>
                            <th>
                                @lang("standardorclass::text.slug")
                            </th>
                            <th>
                                @lang("standardorclass::text.updated_at")
                            </th>
                            <th>
                                @lang("standardorclass::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("standardorclass::text.action")
                            </th>
                        </tr>
                    </thead>
